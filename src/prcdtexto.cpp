...
#define ALFABETO_ITALIANO "a�bcdefghijklmno�pqrstuvwxyzA�BCDEFGHIJKLMNO�PQRSTUVWXYZ"
...
estadisticas_nivel_caracteres(Libro & libro)
{
	...
	//	Variables de tama�os fisico y logico
	int tf = 50, tl=0; 
	//	Arreglo dinamico
...
{
	/*	Agranda el tama�o fisico del arreglo y rellena los nuevos espacios
	 *  nuevos con 0	*/
...
conteo_caracteres(char * libro_caracter, string & caracteres_libro, arreglo & ptr_arreglo_apariciones, int & tl, int & tf)
{
	...
	if(tf == tl){
		/*	Si el tama�o fisico del arreglo es alcanzado por el logico, 
...
estadisticas_nivel_palabras(Libro & libro)
{
	 ...
	 *  se tuvo en cuenta al desarrollar el tama�o de la matriz	*/
